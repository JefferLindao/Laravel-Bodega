	...
	<div class="col-md-12">
	  <div class="box box-purple">
	    <div class="box-header winth-border with-border-purple">
	      <h3 class="box-title">Seguridad - Usuario</h3>
	      	...
	      	<div class="row">
	            ...
	            <div class="row">
	            	<div class="col-xs-12 col-sm-6">
	            		<h3>Editar Usaurio: {{ $usuario->name }}</h3>
	            		@if(count($errors)>0)
	            		...
	            		<div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
	            			...
	            			<input id="name" type="text" name="name" class="form-control" placeholder="Nombre..." value="{{ $usuario->name }}" required autofocus>
                        @if ($errors->has('name'))
	            		...
	            		<div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
	            			...
	            			<input id="email" type="email" name="email" class="form-control" placeholder="Email..." value="{{ $usuario->email }}" required>
	            			@if ($errors->has('email'))
                                <span class="help-block">
