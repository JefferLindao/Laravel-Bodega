...
<ol class="breadcrumb">
  ...
  <li class="active"><i class="fa fa-shopping-cart"></i> Clientes</li>
</ol>
@stop
@section('contenido')
<div class="row">
		            ...
		            <div class="row">
		              <div class="col-sm-8 col-xs-12">
		                <h3>Listado de Clientes
		                	...
		                	@endcan
		                	@can('reporte.cliente')
		                	<a href="{{ URL::to('clientePDF') }}" class="btn btn-social-icon btn-google" title="Reporte" ><i class="fa fa-file-pdf-o"></i></a>
		                	@endcan
		                </h3>
		                ...
		                <div class="table-responsive">
		                  <table class="table table-striped table-bordered table-condensed table-hover">
							    <thead>
							      ...
							      <th>Teléfono</th>
							      <th>Email</th>
							      @canatleast(['cliente.edit', 'cliente.delete'])
							      <th>Opciones</th>
							      @endcanatleast
							    </thead>
							    ...
							    <tr>
							      ...
							      <td>
							      	@can('cliente.edit')
							        <a href="{{URL::action('ClienteController@edit', $per->Pers_codi)}}"><button class="btn btn-info">Editar</button></a>
							        @endcan
							        @can('cliente.delete')
